...
public class InventoryHelper {
    ...
    /** Parse a saved NBT string into an ItemStack for display. */
    public static ItemStack parseStack(String nbt, net.minecraft.client.player.LocalPlayer player) {
        try {
            var reg = player.level().registryAccess();
            var ops = reg.createSerializationContext(net.minecraft.nbt.NbtOps.INSTANCE);
            return ItemStack.CODEC.parse(ops, net.minecraft.nbt.TagParser.parseCompoundFully(nbt))
